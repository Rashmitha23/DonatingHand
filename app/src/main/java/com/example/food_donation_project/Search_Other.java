...
public class Search_Other extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productView=findViewById(R.id.searchrec);
        ...
        ProductAdapter adapter=new ProductAdapter(getApplicationContext(), product_modelList);
        ...
        database.collection("Product").whereEqualTo("type","Others")
                .get()
